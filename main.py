...
## Postgres Database
DATABASE_URL = 'postgresql://postgres:1234@localhost/dbtest'
...
class UserEntry(BaseModel):
    username: str = Field(..., example="rajat")
    password: str = Field(..., example="siver123")
    first_name: str = Field(..., example="Rajat")
    last_name: str = Field(..., example="Saxena")
...
@app.get("/users/{user.id}", response_model=UserList)
